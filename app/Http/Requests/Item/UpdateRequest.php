...
class UpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'name_en' => ['required', Rule::unique('item_translations', 'name')->where('restaurant_id', auth()->user()->restaurant_id)->where('category_id', $this->category_id)->whereNot("item_id", $this->id)],
            'name_ar' => ['required', Rule::unique('item_translations', 'name')->where('restaurant_id', auth()->user()->restaurant_id)->where('category_id', $this->category_id)->whereNot("item_id", $this->id)],
